...
/******************************************* GET USER CHANNEL PROFILE AGGREGATE PIPELINES ***************************/
const getUserChannelProfile = asyncHandler( async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            $lookup :{
                from : "subscriptions",                   //SUBSCRIPTION SCHEMA EXPORTED BY THIS NAME
                localField : " _id ",                      
                foreignField : " channel",
                as: "subscribers"                       //COUNTING SUBSCRIBERS
            }
        },
        {
            $lookup :{
                ...
                as: "subscribedTo"                        //CHANNEL SUBSCRIBED BY ME
            }
        },
        {
            $addFields:{
